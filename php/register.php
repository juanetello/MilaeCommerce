...
<main>
  <section class="container-fluid row justify-content-center reg">
      <section class="col-10 col-sm-6 col-md-6 col-lg-4">
          <form class="form-container-reg w-100" action="register.php" method="POST">
...
<option value="ZW">Zimbabue</option>
              ...
              <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="nacimiento" name="nacimiento" placeholder="Ingrese su nombre" >
              </div>
              <div class="form-group">
                  <label for="genero">Género</label>
                  <div class="form-check">
                      <input class="form-check-input" type="radio" name="genero" id="masc" value="option1">
                      <label class="form-check-label" for="masc">
                          Masculino
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="genero" id="fem" value="option2">
              ...
              <div class="form-group">
                  <label for="repass">Confirmación Contraseña</label>
                  <input type="password" class="form-control" id="repass" name="repass" placeholder="Confirmación"
                         >
              </div>
              <div class="form-group">
                  <label for="repass">Ingrese su avatar</label>
                  <input type="file" class="form-control" id="avatar" name="avatar" >
              </div>
              <div class="form-group form-check">
                  <input type="checkbox" class="form-check-input" id="check" >
                  <label class="form-check-label" for="exampleCheck1"><a href="#">Términos y condiciones</a></label>
              </div>
